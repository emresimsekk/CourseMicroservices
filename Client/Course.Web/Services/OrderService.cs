...
namespace Course.Web.Services
{
    public class OrderService : IOrderService
    {
        ...
        public async Task<OrderCreatedViewModel> CreateOrder(CheckoutInfoInput checkoutInfoInput)
        {
            ...
            if (!responsePayment)
            {
                return new OrderCreatedViewModel() { Error = "Ödeme Alınamadı", IsSuccesfull = false };
            }
            ...
            {
                return new OrderCreatedViewModel() { Error = "Sipariş Oluşturulamadı.", IsSuccesfull = false };
            }
        ...
        public async Task<OrderSuspendViewModel> SuspendOrder(CheckoutInfoInput checkoutInfoInput)
        {
            ...
            if (!responsePayment)
            {
                return new OrderSuspendViewModel() { Error = "Ödeme Alınamadı", IsSuccesful = false };
            }

            await _basketService.Delete();
            return new OrderSuspendViewModel() { IsSuccesful = true };
